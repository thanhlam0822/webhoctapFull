...
<!-- info -->
            ...
            <div class="info">
              <ul class="list-inline">
                ...
                <?php if( in_array( 'number_of_comments', $post_details ) ) { ?>
                  <li><i class="fa fa-comments-o"></i> <?php comments_popup_link( __( 'zero comment', 'wp-newspaper' ), __( 'one comment', 'wp-newspaper' ), __( '% comments', 'wp-newspaper' ) ); ?></li>
                <?php } ?>
         ...
         <?php wp_newspaper_share_buttons(); ?>
</div>
<!-- info-social-wrap -->
...
<div class="single-post">
  ...
  <div class="post-content">
    ...
    <article>
      ...
      <?php
        wp_link_pages( array(
          'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'wp-newspaper' ),
          'after'  => '</div>',
        ) );
      ?>     
    </article>

    <div class="article-footer-social"><?php wp_newspaper_share_buttons(); ?></div>
