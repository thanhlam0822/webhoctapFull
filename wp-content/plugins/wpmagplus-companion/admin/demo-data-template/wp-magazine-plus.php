...
$demo_templates_lists = array(
    ...
    'wp-magazine' =>array(
        'title' => esc_html__( 'WP Magazine', 'wpmagplus-companion' ),/*Title*/
        'is_pro' => false,  /*Premium*/
        'type' => 'free',
        'author' => esc_html__( 'WPMagPlus', 'wpmagplus-companion' ),    /*Author Name*/
        'keywords' => array( 'WP Magazine'),  /*Search keyword*/
        'categories' => array( 'magazine' ), /*Categories*/
        'template_url' => array(
            'content' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-magazine/content.json',
            'options' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-magazine/options.json',
            'widgets' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-magazine/widgets.json'
        ),
        'screenshot_url' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-magazine/wp-magazine-free.jpg',
        'demo_url' => 'https://wpmagplus.com/preview/?product_id=magazine',
        'plugins' => ''
    ),

    'wp-news' =>array(
        'title' => esc_html__( 'WP News', 'wpmagplus-companion' ),/*Title*/
        'is_pro' => false,  /*Premium*/
        'type' => 'free',
        'author' => esc_html__( 'WPMagPlus', 'wpmagplus-companion' ),    /*Author Name*/
        'keywords' => array( 'WP News'),  /*Search keyword*/
        'categories' => array( 'news' ), /*Categories*/
        'template_url' => array(
            'content' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-news/content.json',
            'options' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-news/options.json',
            'widgets' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-news/widgets.json'
        ),
        'screenshot_url' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-news/wp-news.jpg',
        'demo_url' => 'https://wpmagplus.com/preview/?product_id=News',
        'plugins' => ''
    ),
    ...
    'travel-magazine-lite' =>array(
        'title' => esc_html__( 'Travel Magazine Lite', 'wpmagplus-companion' ),/*Title*/
        'is_pro' => false,  /*Premium*/
        'type' => 'free',
        'author' => esc_html__( 'WPMagPlus', 'wpmagplus-companion' ),    /*Author Name*/
        'keywords' => array( 'Travel Magazine Lite'),  /*Search keyword*/
        'categories' => array( 'magazine', 'travel' ), /*Categories*/
        'template_url' => array(
            'content' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/travel-magazine-lite/content.json',
            'options' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/travel-magazine-lite/options.json',
            'widgets' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/travel-magazine-lite/widgets.json'
        ),
        'screenshot_url' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/travel-magazine-lite/travel-magazine-lite.jpg',
        'demo_url' => 'https://demo.wpmagplus.com/travel-magazine-lite/',
        'plugins' => ''
    ),

    'wp-lifestyle' =>array(
        'title' => esc_html__( 'WP Lifestyle', 'wpmagplus-companion' ),/*Title*/
        'is_pro' => false,  /*Premium*/
        'type' => 'free',
        'author' => esc_html__( 'WPMagPlus', 'wpmagplus-companion' ),    /*Author Name*/
        'keywords' => array( 'WP Lifestyle'),  /*Search keyword*/
        'categories' => array( 'lifestyle' ), /*Categories*/
        'template_url' => array(
            'content' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-lifestyle/content-plus.json',
            'options' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-lifestyle/options-plus.json',
            'widgets' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-lifestyle/widgets-plus.json'
        ),
        'screenshot_url' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/wp-lifestyle/wp-lifestyle.jpg',
        'demo_url' => 'https://wpmagplus.com/preview/?product_id=Lifestyle',
        'plugins' => ''
    ),
    

    'photography' =>array(
        'title' => esc_html__( 'Photography', 'wpmagplus-companion' ),/*Title*/
        'is_pro' => false,  /*Premium*/
        'type' => 'free',
        'author' => esc_html__( 'WPMagPlus', 'wpmagplus-companion' ),    /*Author Name*/
        'keywords' => array( 'Photography'),  /*Search keyword*/
        'categories' => array( 'others' ), /*Categories*/
        'template_url' => array(
            'content' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/photography/content.json',
            'options' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/photography/options.json',
            'widgets' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/photography/widgets.json'
        ),
        'screenshot_url' => WPMAGPLUS_COMPANION_TEMPLATE_URL.'/photography/wp-photography.jpg',
        'demo_url' => 'https://wpmagplus.com/preview/?product_id=Photography',
        'plugins' => ''
    ),
